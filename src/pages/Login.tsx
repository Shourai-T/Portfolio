  ...
  return (
    <div className="min-h-screen bg-dark-bg flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        <div className="bg-dark-hover/50 backdrop-blur-xl border border-dark-border rounded-2xl p-8 shadow-2xl">
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-white text-dark-bg hover:bg-gray-100 font-bold py-3 px-6 rounded-xl transition-all flex items-center justify-center gap-3 disabled:opacity-70 disabled:cursor-not-allowed group shadow-lg hover:shadow-white/20"
          >
            {loading ? (
