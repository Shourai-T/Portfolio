          ...
          <div className={`grid ${
            ...
            {filteredPhotos.map((photo) => (
              <button
                ...
                className="group relative aspect-square overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all bg-gradient-to-br from-purple-500 to-pink-600"
              >
                <img
